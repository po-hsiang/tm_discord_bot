...
> 版本：`0.2.10`｜語言：Python 3.14｜套件管理：uv｜AI：n8n AI Agent 微服務｜部署：Docker Compose
...
| `!投票賽` | 8 強按鈕投票淘汰賽——全頻道按按鈕投票（一人一票、可改票、開票前保密），每輪 30 秒最高票晉級，平手隨機；一次只開一場 | Google Sheets 候選清單 |
| `!心結` | 彩蛋固定回覆 | 內建 |
...
└── tm_discord_bot/
    ...
    └── scripts/
        ...
        └── plugins/
            ...
            ├── vote_tournament.py       # 按鈕投票淘汰賽（全頻道按鈕投票）
